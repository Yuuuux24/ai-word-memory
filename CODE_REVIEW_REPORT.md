...
| 级别 | 编号 | 问题 | 状态 |
|------|------|------|:----:|
| P0 | ① | 5文件重复定义 `json_response` | ✅ 已修复 |
| P0 | ② | `/memo` 和 `/generate` 代码100%重复 | ✅ 已修复 |
| P0 | ③ | 所有接口零鉴权 | ✅ 已修复 |
| P1 | ④ | 学习记录分页计数 bug | ✅ 已修复 |
| P1 | ⑤ | 异常信息直接泄给前端 | ✅ 已修复 |
| P1 | ⑥ | localStorage 存 user_id（XSS 风险） | ✅ 已修复 |
| P1 | ⑦ | 闯关重置发 N 条请求 | ✅ 已修复 |
| P1 | ⑧ | 闭包陷阱 | ⚠️ 低风险 |
| P2 | ⑨ | f-string SQL 拼接风险 | ✅ 非 SQL（PostgREST） |
| P2 | ⑩ | 闯关只取前10个词 | ⚠️ 设计决策 |
| P2 | ⑪ | `from_cache` 死代码 | ✅ 已移除 |
| P2 | ⑫ | 全链路无日志 | ✅ 已修复 |
